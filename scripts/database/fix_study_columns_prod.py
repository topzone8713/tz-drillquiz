#!/usr/bin/env python3
"""
운영 환경 PostgreSQL DB에서 quiz_study 테이블의 created_at과 updated_at 컬럼을 삭제하는 스크립트
"""
...
os.environ['POSTGRES_PORT'] = '63784'
...
def main():
    """메인 함수"""
    print("🚀 운영 환경 PostgreSQL DB quiz_study 테이블 컬럼 삭제 스크립트 시작")
    print("=" * 60)
    ...
    try:
        ...
        print(f"❌ DB 연결 실패: {e}")
        print("💡 포트포워딩이 올바르게 설정되었는지 확인하세요 (localhost:63784)")
        return
